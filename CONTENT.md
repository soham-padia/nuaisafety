...
Use close to verbatim. `[BRACKETS]` mark decisions that need a human answer first, see `FACTS.md`.
...
**Soham Padia** MS in Artificial Intelligence
Works on interpretability with a postdoc in David Bau's lab. Built and runs a public
